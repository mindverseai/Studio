...
class AlreadySetupError(BaseHTTPException):
    ...
    description = "Mindverse has been successfully installed. Please refresh the page or return to the dashboard homepage."
    code = 403
...
class NotSetupError(BaseHTTPException):
    ...
    description = (
        "Mindverse has not been initialized and installed yet. "
