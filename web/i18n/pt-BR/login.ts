const translation = {
  ...
  welcome: 'Bem-vindo ao Mindverse, faça login para continuar.',
  ...
  license: {
    tip: 'Antes de começar a usar a Edição Comunitária do Mindverse, leia a',
    link: 'Licença de código aberto do GitHub',
  },
  join: 'Participar',
  joinTipStart: 'Convidamos você a participar da',
  joinTipEnd: 'equipe no Mindverse',
  invalid: 'O link expirou',
  explore: 'Explorar o Mindverse',
  ...
  resetPasswordDesc: 'Digite o e-mail que você usou para se inscrever no Mindverse e enviaremos um e-mail de redefinição de senha.',
  sendVerificationCode: 'Enviar código de verificação',
  usePassword: 'Usar senha',
  licenseInactiveTip: 'A licença do Mindverse Enterprise para seu espaço de trabalho está inativa. Entre em contato com o administrador para continuar usando o Mindverse.',
  licenseLostTip: 'Falha ao conectar o servidor de licenças Mindverse. Entre em contato com o administrador para continuar usando o Mindverse.',
  licenseExpired: 'Licença expirada',
  licenseLost: 'Licença perdida',
  licenseInactive: 'Licença inativa',
  licenseExpiredTip: 'A licença do Mindverse Enterprise para seu espaço de trabalho expirou. Entre em contato com o administrador para continuar usando o Mindverse.',
}
