const translation = {
  ...
  apiKeyInfo: {
    ...
    tryCloud: 'Veya Mindverse\'nin bulut sürümünü ücretsiz kotayla deneyin',
  },
  overview: {
    title: 'Genel Bakış',
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip: 'Ziyaretçilerin uygulamanın topladığı verileri anlamalarına yardımcı olur, Mindverse\'nin <privacyPolicyLink>Gizlilik Politikası</privacyPolicyLink>\'na bakın.',
      ...
      embedded: {
        ...
        chromePlugin: 'Mindverse Chatbot Chrome Eklentisini Yükleyin',
        copied: 'Kopyalandı',
        copy: 'Kopyala',
      },
      qrcode: {
