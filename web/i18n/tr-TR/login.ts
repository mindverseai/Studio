const translation = {
  ...
  welcome: 'Mindverse\'ye hoş geldiniz, devam etmek için lütfen giriş yapın.',
  ...
  license: {
    tip: 'Mindverse Community Edition\'ı başlatmadan önce GitHub\'daki',
  ...
  resetPasswordDesc: 'Mindverse\'a kaydolmak için kullandığınız e-postayı yazın, size bir şifre sıfırlama e-postası gönderelim.',
  ...
  back: 'Geri',
  licenseExpiredTip: 'Çalışma alanınız için Mindverse Enterprise lisansının süresi doldu. Mindverse\'ı kullanmaya devam etmek için lütfen yöneticinizle iletişime geçin.',
  licenseLostTip: 'Mindverse lisans sunucusuna bağlanılamadı. Mindverse\'ı kullanmaya devam etmek için lütfen yöneticinizle iletişime geçin.',
  licenseInactiveTip: 'Çalışma alanınız için Mindverse Enterprise lisansı etkin değil. Mindverse\'ı kullanmaya devam etmek için lütfen yöneticinizle iletişime geçin.',
