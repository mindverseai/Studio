const translation = {
  ...
  intro1: 'Bilgi, Mindverse uygulamasına ',
  ...
  externalAPIPanelDescription: 'Harici bilgi API\'si, Mindverse dışındaki bir bilgi bankasına bağlanmak ve bu bilgi bankasından bilgi almak için kullanılır.',
