const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Mindverse hesabı',
    langGeniusAccountTip: 'Mindverse hesabınız ve ilişkili kullanıcı verileri.',
  ...
  members: {
    ...
    invitationSentTip: 'Davet gönderildi, Mindverse\'ye giriş yaparak takım verilerinize erişebilirler.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      onTrial: 'DENEMEDE',
      exhausted: 'KOTA DOLU',
      desc: 'Mindverse tarafından sağlanan OpenAI barındırma hizmeti, GPT-3.5 gibi modelleri kullanmanıza olanak tanır. Deneme kotanız bitmeden önce, diğer model sağlayıcılarını ayarlamanız gerekir.',
  ...
  about: {
    ...
    nowAvailable: 'Mindverse {{version}} şimdi mevcut.',
    latestAvailable: 'Mindverse {{version}} en son mevcut sürüm.',
  },
  appMenus: {
    overview: 'İzleme',
