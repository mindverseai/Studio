const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Compte Mindverse',
    langGeniusAccountTip: 'Votre compte Mindverse et les données utilisateur associées.',
  ...
  members: {
    ...
    invitationSentTip: 'Invitation envoyée, ils peuvent se connecter à Mindverse pour accéder aux données de votre équipe.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'Le service d\'hébergement OpenAI fourni par Mindverse vous permet d\'utiliser des modèles tels que GPT-3.5. Avant l\'épuisement de votre quota d\'essai, vous devez configurer d\'autres fournisseurs de modèles.',
  ...
  apiBasedExtension: {
    title: 'Les extensions API fournissent une gestion centralisée des API et simplifient la configuration pour une utilisation facile dans les applications Mindverse.',
    link: 'Apprenez comment développer votre propre Extension API.',
    linkUrl: 'https://docs.mindverse.ai/fonctionnalites/extension/extension_basee_sur_api',
  ...
  about: {
    ...
    nowAvailable: 'Mindverse {{version}} est maintenant disponible.',
    latestAvailable: 'Mindverse {{version}} est la dernière version disponible.',
  },
  appMenus: {
