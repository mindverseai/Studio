const translation = {
  ...
  intro1: 'La base de connaissances peut être intégrée dans l\'application Mindverse',
  ...
  externalAPIPanelDescription: 'L\'API de connaissances externe est utilisée pour se connecter à une base de connaissances en dehors de Mindverse et récupérer des connaissances de cette base de connaissances.',
