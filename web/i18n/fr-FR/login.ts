const translation = {
  ...
  welcome: '👋 Bienvenue sur Mindverse, veuillez vous connecter pour continuer.',
  ...
  license: {
    tip: 'Avant de commencer avec Mindverse Community Edition, veuillez lire',
    link: 'Licence Open-source',
  },
  join: 'Rejoindre',
  joinTipStart: 'Je vous invite à rejoindre',
  joinTipEnd: 'équipe sur Mindverse',
  invalid: 'Le lien a expiré',
  explore: 'Explorer Mindverse',
  ...
  resetPasswordDesc: 'Saisissez l\'e-mail que vous avez utilisé pour vous inscrire à Mindverse et nous vous enverrons un e-mail de réinitialisation du mot de passe.',
  usePassword: 'Utiliser le mot de passe',
  licenseInactiveTip: 'La licence Mindverse Enterprise de votre espace de travail est inactive. Veuillez contacter votre administrateur pour continuer à utiliser Mindverse.',
  licenseLostTip: 'Impossible de se connecter au serveur de licence Mindverse. Veuillez contacter votre administrateur pour continuer à utiliser Mindverse.',
  licenseExpired: 'Licence expirée',
  licenseLost: 'Licence perdue',
  licenseExpiredTip: 'La licence Mindverse Enterprise de votre espace de travail a expiré. Veuillez contacter votre administrateur pour continuer à utiliser Mindverse.',
