const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Mindverse račun',
    langGeniusAccountTip: 'Vaš Mindverse račun in povezani uporabniški podatki.',
    editName: 'Uredi ime',
  ...
  members: {
    ...
    invitationSentTip: 'Povabilo poslano, in po prijavi v Mindverse bodo imeli dostop do vaših podatkov ekipe.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'Gostitvena storitev OpenAI, ki jo ponuja Mindverse, vam omogoča uporabo modelov, kot je GPT-3.5. Preden porabite kvoto za preizkus, morate nastaviti druge ponudnike modelov.',
  ...
  modelProvider: {
    ...
    apiBasedExtension: {
      title: 'Razširitve API omogočajo centralizirano upravljanje API, kar poenostavi konfiguracijo za enostavno uporabo v aplikacijah Mindverse.',
    ...
    about: {
      ...
      nowAvailable: 'Mindverse {{version}} je zdaj na voljo.',
      latestAvailable: 'Mindverse {{version}} je najnovejša različica na voljo.',
    },
    appMenus: {
      overview: 'Nadzor',
  ...
  apiBasedExtension: {
    ...
    title: 'Razširitve API zagotavljajo centralizirano upravljanje API, kar poenostavlja konfiguracijo za enostavno uporabo v aplikacijah Mindverse.',
    linkUrl: 'https://docs.dify.ai/features/extension/api_based_extension',
  ...
  about: {
    updateNow: 'Posodobi zdaj',
    nowAvailable: 'Mindverse {{version}} je zdaj na voljo.',
    latestAvailable: 'Mindverse {{version}} je najnovejša različica, ki je na voljo.',
    changeLog: 'Dnevnik sprememb',
  },
  appMenus: {
