const translation = {
  list: {
    title: 'Dokumenti',
    desc: 'Vse datoteke znanja so prikazane tukaj, celotno znanje pa je mogoče povezati s citati Mindverse ali indeksirati prek vtičnika Chat.',
    ...
    empty: {
      ...
      sync: {
        tip: 'Mindverse bo občasno prenesel datoteke iz Notion in dokončal obdelavo.',
      },
    },
    delete: {
