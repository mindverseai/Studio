const translation = {
  ...
  apiKeyInfo: {
    ...
    tryCloud: 'Ali preizkusite oblačno različico Mindverse s prosto kvoto',
  },
  overview: {
    title: 'Pregled',
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip: 'Pomaga obiskovalcem razumeti, katere podatke aplikacija zbira, glejte <privacyPolicyLink>politiko zasebnosti</privacyPolicyLink> Mindverse.',
      ...
      embedded: {
        ...
        chromePlugin: 'Namestite Mindverse Chatbot razširitev za Chrome',
        copied: 'Kopirano',
        copy: 'Kopiraj',
      },
      qrcode: {
