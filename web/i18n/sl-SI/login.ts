const translation = {
  ...
  welcome: 'Dobrodošli v Mindverse, prosimo, prijavite se za nadaljevanje.',
  ...
  license: {
    tip: 'Preden začnete z Mindverse Community Edition, preberite GitHub',
    link: 'Licenco odprte kode',
  },
  join: 'Pridruži se',
  joinTipStart: 'Vabimo vas, da se pridružite',
  joinTipEnd: 'ekipi na Mindverse',
  invalid: 'Povezava je potekla',
  explore: 'Razišči Mindverse',
  ...
  licenseExpiredTip: 'Licenca za Mindverse Enterprise za vaš delovni prostor je potekla. Če želite še naprej uporabljati Mindverse, se obrnite na skrbnika.',
  usePassword: 'Uporaba gesla',
  sendVerificationCode: 'Pošlji kodo za preverjanje',
  resetPasswordDesc: 'Vnesite e-poštni naslov, ki ste ga uporabili za prijavo na Mindverse, in poslali vam bomo e-poštno sporočilo za ponastavitev gesla.',
  ...
  licenseLostTip: 'Povezava z licenčnim strežnikom Mindverse ni uspela. Če želite še naprej uporabljati Mindverse, se obrnite na skrbnika.',
  licenseInactiveTip: 'Licenca Mindverse Enterprise za vaš delovni prostor je neaktivna. Če želite še naprej uporabljati Mindverse, se obrnite na skrbnika.',
}
