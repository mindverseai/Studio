const translation = {
  ...
  welcome: 'Willkommen bei Mindverse, bitte melden Sie sich an, um fortzufahren.',
  ...
  license: {
    tip: 'Bevor Sie mit der Mindverse Community Edition beginnen, lesen Sie bitte',
    link: 'Open-Source-Lizenz',
  },
  join: 'Beitreten',
  joinTipStart: 'Lade dich ein, dem',
  joinTipEnd: 'Team auf Mindverse beizutreten',
  invalid: 'Der Link ist abgelaufen',
  explore: 'Mindverse erkunden',
  ...
  resetPasswordDesc: 'Geben Sie die E-Mail-Adresse ein, mit der Sie sich bei Mindverse registriert haben, und wir senden Ihnen eine E-Mail zum Zurücksetzen des Passworts.',
  ...
  licenseLostTip: 'Verbindung zum Mindverse-Lizenzserver fehlgeschlagen. Bitte kontaktieren Sie Ihren Administrator, um Mindverse weiter zu nutzen.',
  licenseInactive: 'Lizenz inaktiv',
  licenseInactiveTip: 'Die Mindverse Enterprise-Lizenz für Ihren Arbeitsbereich ist inaktiv. Bitte kontaktieren Sie Ihren Administrator, um Mindverse weiter zu nutzen.',
  licenseExpiredTip: 'Die Mindverse Enterprise-Lizenz für Ihren Arbeitsbereich ist abgelaufen. Bitte kontaktieren Sie Ihren Administrator, um Mindverse weiter zu nutzen.',
