const translation = {
  ...
  intro1: 'Wissen kann in Mindverse-Anwendungen integriert werden',
  intro2: 'als Kontext',
  intro3: ',',
  intro4: 'oder es ',
  ...
  externalAPIPanelDescription: 'Die externe Wissens-API wird verwendet, um eine Verbindung zu einer Wissensdatenbank außerhalb von Mindverse herzustellen und Wissen aus dieser Wissensdatenbank abzurufen.',
  ...
  externalKnowledgeName: 'Name des externen Wissen',
