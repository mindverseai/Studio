const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Mindverse-Konto',
    langGeniusAccountTip: 'Ihr Mindverse-Konto und zugehörige Benutzerdaten.',
  ...
  members: {
    ...
    invitationSentTip: 'Einladung gesendet. Die Person kann sich bei Mindverse anmelden, um auf Ihre Team-Daten zuzugreifen.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'Der von Mindverse bereitgestellte OpenAI-Hosting-Service ermöglicht Ihnen die Nutzung von Modellen wie GPT-3.5. Bevor Ihr Testkontingent aufgebraucht ist, müssen Sie andere Modellanbieter einrichten.',
  ...
  about: {
    ...
    nowAvailable: 'Mindverse {{version}} ist jetzt verfügbar.',
    latestAvailable: 'Mindverse {{version}} ist die neueste verfügbare Version.',
  },
  appMenus: {
    overview: 'Übersicht',
