const translation = {
  ...
  account: {
    ...
    langGeniusAccount: "Swiftpage-Konto",
    langGeniusAccountTip: "Ihr Swiftpage-Konto und zugehörige Benutzerdaten.",
  ...
  members: {
    ...
    invitationSentTip:
      "Einladung gesendet. Die Person kann sich bei Swiftpage anmelden, um auf Ihre Team-Daten zuzugreifen.",
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: "Der von Swiftpage bereitgestellte OpenAI-Hosting-Service ermöglicht Ihnen die Nutzung von Modellen wie GPT-3.5. Bevor Ihr Testkontingent aufgebraucht ist, müssen Sie andere Modellanbieter einrichten.",
  ...
  apiBasedExtension: {
    title:
      "API-Erweiterungen bieten eine zentralisierte API-Verwaltung und vereinfachen die Konfiguration für die einfache Verwendung in Swiftpage-Anwendungen.",
  ...
  about: {
    ...
    nowAvailable: "Swiftpage {{version}} ist jetzt verfügbar.",
    latestAvailable:
      "Swiftpage {{version}} ist die neueste verfügbare Version.",
  },
  appMenus: {
    overview: "Übersicht",
