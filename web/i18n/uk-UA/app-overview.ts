const translation = {
  ...
  apiKeyInfo: {
    ...
    tryCloud: 'Або спробуйте хмарну версію Mindverse з безкоштовним цитатою',
  },
  overview: {
    title: 'Огляд',
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip: 'Допомагає відвідувачам зрозуміти дані, зібрані додатком, див. <privacyPolicyLink>Політику конфіденційності</privacyPolicyLink> Mindverse.',
      ...
      embedded: {
        ...
        chromePlugin: 'Встановити розширення Chrome Mindverse Chatbot',
        copied: 'Скопійовано',
        copy: 'Скопіювати',
      },
      qrcode: {
      ...
      customize: {
        ...
        way1: {
          ...
          step1Operation: 'Клієнт-Web-Mindverse',
