const translation = {
  ...
  welcome: 'Ласкаво просимо до Mindverse, будь ласка, увійдіть, щоб продовжити.',
  ...
  license: {
    tip: 'Перед запуском Mindverse Community Edition ознайомтеся з ліцензією з відкритим кодом на GitHub',
    link: 'Ліцензія з відкритим кодом',
  },
  join: 'Приєднуйтесь',
  joinTipStart: 'Запрошуємо вас приєднатися',
  joinTipEnd: 'команда Mindverse',
  invalid: 'Посилання застаріло',
  explore: 'Досліджуйте Mindverse',
  ...
  resetPasswordDesc: 'Введіть адресу електронної пошти, яку ви використовували для реєстрації на Mindverse, і ми надішлемо вам електронний лист для скидання пароля.',
  resetPassword: 'Скинути пароль',
  licenseLostTip: 'Не вдалося підключити сервер ліцензій Mindverse. Будь ласка, зверніться до свого адміністратора, щоб продовжити користуватися Mindverse.',
  licenseExpired: 'Термін дії ліцензії минув',
  licenseInactive: 'Ліцензія неактивна',
  licenseLost: 'Ліцензію втрачено',
  licenseInactiveTip: 'Ліцензія Mindverse Enterprise для вашої робочої області неактивна. Будь ласка, зверніться до свого адміністратора, щоб продовжити користуватися Mindverse.',
  licenseExpiredTip: 'Термін дії ліцензії Mindverse Enterprise для вашого робочого простору закінчився. Будь ласка, зверніться до свого адміністратора, щоб продовжити користуватися Mindverse.',
}
