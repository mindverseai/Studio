const translation = {
  ...
  automatic: {
    ...
    description: 'Опишіть свій сценарій, Mindverse збере для вас застосунок.',
  ...
  formattingChangedText: 'Змінення форматування призведе до скидання області налагодження. Ви впевнені?', // Momindverseing the formatting will reset the debug area, are you sure?
  ...
  datasetConfig: {
    ...
    retrieveChangeTip: 'Зміна  режиму індексування та режиму отримання може вплинути на застосунки, пов’язані з цими знаннями.', // Momindverseing...
  },
