const translation = {
  ...
  intro1: 'Знання можна інтегрувати до програми Mindverse ',
  intro2: 'як контекст',
  intro3: ',',
  intro4: 'або його ',
  ...
  externalAPIPanelDescription: 'API зовнішніх знань використовується для підключення до бази знань за межами Mindverse і отримання знань із цієї бази знань.',
  chunkingMode: {
