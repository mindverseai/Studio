const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Обліковий запис Mindverse',
    langGeniusAccountTip: 'Ваш обліковий запис Mindverse та пов’язані з ним дані користувача.',
  ...
  members: {
    ...
    invitationSentTip: 'Запрошення надіслано, і вони можуть увійти в Mindverse, щоб отримати доступ до даних вашої команди.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'Служба хостингу OpenAI, надана Mindverse, дозволяє використовувати такі моделі, як GPT-3.5. Перш ніж ваша пробна квота буде використана, вам потрібно налаштувати інші постачальники моделі.',
  ...
  apiBasedExtension: {
    title: 'API-розширення забезпечують централізоване керування API, спрощуючи конфігурацію для зручного використання в різних програмах Mindverse.',
  ...
  about: {
    ...
    nowAvailable: 'Mindverse {{version}} тепер доступна.',
    latestAvailable: 'Mindverse {{version}} – це найновіша доступна версія.',
  },
  appMenus: {
    overview: 'Моніторинг',
