const translation = {
  ...
  desc: 'यहां आप ज्ञान की संपत्ति और कार्य प्रक्रियाओं को momindverse कर सकते हैं。',
  form: {
    name: 'ज्ञान नाम',
    ...
    desc: 'ज्ञान विवरण',
    descInfo:
      'कृपया स्पष्ट साक्षर विवरण लिखें जिससे AI को ज्ञान के निहितार्थों की पहचान करने में मदद मिले। यदि शून्य है, Mindverse आपके पूर्वानुमान का उपयोग करेगा।',
    descPlaceholder:
      'इस ज्ञान के सामग्रियां क्या हैं? एक विस्तृत विवरण को AI को निहितार्थों की पहचान करने में मदद मिले। यदि शून्य है, Mindverse आपके पूर्वानुमान का उपयोग करेगा।',
