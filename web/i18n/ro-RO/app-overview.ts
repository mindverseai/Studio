const translation = {
  ...
  apiKeyInfo: {
    ...
    tryCloud: 'Sau încercați versiunea cloud a Mindverse cu cotă gratuită',
  },
  overview: {
    ...
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip: 'Ajută vizitatorii să înțeleagă datele pe care le colectează aplicația, consultați <privacyPolicyLink>Politica de confidențialitate</privacyPolicyLink> a Mindverse.',
      ...
      embedded: {
        ...
        chromePlugin: 'Instalați extensia Chrome Mindverse Chatbot',
        copied: 'Copiat',
        copy: 'Copiați',
      },
      qrcode: {
