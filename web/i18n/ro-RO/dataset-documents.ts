const translation = {
  list: {
    title: 'Documente',
    desc: 'Toate fișierele din Cunoștințe sunt afișate aici, iar întreaga Cunoaștere poate fi legată de citări Mindverse sau indexată prin intermediul pluginului Chat.',
    ...
    empty: {
      ...
      sync: {
        tip: 'Mindverse va descărca periodic fișiere din Notion și va finaliza procesarea.',
      },
    },
    delete: {
