const translation = {
  ...
  welcome: 'Bine ai venit la Mindverse, te rugăm să te autentifici pentru a continua.',
  ...
  license: {
    tip: 'Înainte de a începe Mindverse Community Edition, citește',
    link: 'Licența open-source de pe GitHub',
  },
  join: 'Alătură-te',
  joinTipStart: 'Te invităm să te alături echipei',
  joinTipEnd: 'pe Mindverse',
  invalid: 'Link-ul a expirat',
  explore: 'Explorează Mindverse',
  ...
  or: 'SAU',
  resetPasswordDesc: 'Tastați e-mailul pe care l-ați folosit pentru a vă înscrie pe Mindverse și vă vom trimite un e-mail de resetare a parolei.',
  changePasswordBtn: 'Setați o parolă',
  licenseLostTip: 'Nu s-a reușit conectarea serverului de licențe Mindverse. Contactați administratorul pentru a continua să utilizați Mindverse.',
  licenseInactive: 'Licență inactivă',
  licenseInactiveTip: 'Licența Mindverse Enterprise pentru spațiul de lucru este inactivă. Contactați administratorul pentru a continua să utilizați Mindverse.',
  licenseExpired: 'Licență expirată',
  licenseLost: 'Licență pierdută',
  licenseExpiredTip: 'Licența Mindverse Enterprise pentru spațiul de lucru a expirat. Contactați administratorul pentru a continua să utilizați Mindverse.',
}
