const translation = {
  ...
  welcome: '👋 Bienvenido a Mindverse, inicie sesión para continuar.',
  ...
  license: {
    tip: 'Antes de comenzar con Mindverse Community Edition, por favor lea',
    link: 'Licencia de código abierto de GitHub',
  },
  join: 'Unirse',
  joinTipStart: 'Te invita a unirte al equipo de',
  joinTipEnd: 'en Mindverse',
  invalid: 'El enlace ha expirado',
  explore: 'Explorar Mindverse',
  ...
  resetPasswordDesc: 'Escriba el correo electrónico que utilizó para registrarse en Mindverse y le enviaremos un correo para restablecer su contraseña.',
  ...
  licenseInactiveTip: 'La licencia Mindverse Enterprise para su espacio de trabajo está inactiva. Contacte a su administrador para continuar usando Mindverse.',
  licenseExpired: 'Licencia caducada',
  licenseLost: 'Licencia perdida',
  licenseExpiredTip: 'La licencia Mindverse Enterprise para su espacio de trabajo ha expirado. Contacte a su administrador para continuar usando Mindverse.',
  licenseLostTip: 'No se pudo conectar al servidor de licencias de Mindverse. Contacte a su administrador para continuar usando Mindverse.',
}
