const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Cuenta Mindverse',
    langGeniusAccountTip: 'Su cuenta Mindverse y datos de usuario relacionados.',
  ...
  members: {
    ...
    invitationSentTip: 'Invitación enviada, pueden iniciar sesión en Mindverse para acceder a los datos de su equipo.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'El servicio de alojamiento OpenAI proporcionado por Mindverse le permite usar modelos como GPT-3.5. Antes de que se agote su cuota de prueba, debe configurar otros proveedores de modelos.',
  ...
  apiBasedExtension: {
    title: 'Las extensiones API proporcionan una gestión centralizada de API y simplifican la configuración para un uso fácil en las aplicaciones Mindverse.',
  ...
  about: {
    ...
    nowAvailable: 'Mindverse {{version}} está ahora disponible.',
    latestAvailable: 'Mindverse {{version}} es la última versión disponible.',
  },
  appMenus: {
    overview: 'Monitoreo',
    promptEng: 'Orquestar',
