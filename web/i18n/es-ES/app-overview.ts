const translation = {
  ...
  apiKeyInfo: {
    ...
    tryCloud: 'O prueba la versión en la nube de Mindverse con una cotización gratuita',
  },
  overview: {
    title: 'Resumen',
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip: 'Ayuda a los visitantes a comprender los datos que recopila la aplicación, consulta la <privacyPolicyLink>Política de privacidad</privacyPolicyLink> de Mindverse.',
      ...
      embedded: {
        ...
        chromePlugin: 'Instalar la extensión de Chrome de Mindverse Chatbot',
        copied: 'Copiado',
        copy: 'Copiar',
      },
      qrcode: {
      ...
      customize: {
        ...
        way1: {
          ...
          step1Operation: 'Mindverse-WebClient',
