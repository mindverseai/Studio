const translation = {
  ...
  didYouKnow: '¿Sabías?',
  intro1: 'La base de conocimientos puede ser integrada en la aplicación Mindverse',
  ...
  externalAPIPanelDescription: 'La API de conocimiento externo se utiliza para conectarse a una base de conocimiento fuera de Mindverse y recuperar conocimiento de esa base de conocimiento.',
