const translation = {
  ...
  apiKeyInfo: {
    ...
    tryCloud: 'Lub wypróbuj wersję chmurową Mindverse z darmowym limitem',
  },
  overview: {
    title: 'Przegląd',
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip:
            'Pomaga odwiedzającym zrozumieć, jakie dane zbiera aplikacja, zobacz <privacyPolicyLink>Politykę prywatności Mindverse</privacyPolicyLink>.',
      ...
      embedded: {
        ...
        chromePlugin: 'Zainstaluj rozszerzenie Chrome Mindverse Chatbot',
        copied: 'Skopiowane',
        copy: 'Kopiuj',
      },
      qrcode: {
