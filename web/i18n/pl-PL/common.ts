const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Konto Mindverse',
    langGeniusAccountTip: 'Twoje konto Mindverse i powiązane dane użytkownika.',
  ...
  members: {
    ...
    invitationSentTip:
      'Zaproszenie zostało wysłane, a oni mogą zalogować się do Mindverse, aby uzyskać dostęp do danych Twojego zespołu.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'Usługa hostowania OpenAI dostarczana przez Mindverse pozwala korzystać z modeli takich jak GPT-3.5. Przed wyczerpaniem limitu próbnego należy skonfigurować inne dostawców modeli.',
  ...
  apiBasedExtension: {
    title:
      'Rozszerzenia oparte na interfejsie API zapewniają scentralizowane zarządzanie interfejsami API, upraszczając konfigurację dla łatwego użytkowania w aplikacjach Mindverse.',
  ...
  about: {
    ...
    nowAvailable: 'Mindverse {{version}} jest teraz dostępny.',
    latestAvailable: 'Mindverse {{version}} jest najnowszą dostępną wersją.',
  },
  appMenus: {
