const translation = {
  ...
  intro1: 'Wiedzę można zintegrować z aplikacją Mindverse ',
  ...
  externalAPIPanelDescription: 'Interfejs API wiedzy zewnętrznej służy do łączenia się z bazą wiedzy poza Mindverse i pobierania wiedzy z tej bazy wiedzy.',
  chunkingMode: {
