const translation = {
  ...
  welcome: 'Witaj w Mindverse, zaloguj się, aby kontynuować.',
  email: 'Adres e-mail',
  ...
  license: {
    tip: 'Przed rozpoczęciem wersji społecznościowej Mindverse, przeczytaj GitHub',
    link: 'Licencję open-source',
  },
  join: 'Dołącz',
  joinTipStart: 'Zapraszam Cię do dołączenia do',
  joinTipEnd: 'zespołu na Mindverse',
  invalid: 'Link wygasł',
  explore: 'Odkryj Mindverse',
  ...
  resetPasswordDesc: 'Wpisz adres e-mail, którego użyłeś do rejestracji w Mindverse, a my wyślemy Ci wiadomość e-mail z prośbą o zresetowanie hasła.',
  or: 'LUB',
  ...
  licenseExpiredTip: 'Licencja Mindverse Enterprise dla Twojego obszaru roboczego wygasła. Skontaktuj się z administratorem, aby kontynuować korzystanie z Mindverse.',
  licenseLostTip: 'Nie udało się nawiązać połączenia z serwerem licencji Mindverse. Skontaktuj się z administratorem, aby kontynuować korzystanie z Mindverse.',
  licenseInactiveTip: 'Licencja Mindverse Enterprise dla Twojego obszaru roboczego jest nieaktywna. Skontaktuj się z administratorem, aby kontynuować korzystanie z Mindverse.',
}
