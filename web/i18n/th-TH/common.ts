const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'บัญชี Mindverse',
    langGeniusAccountTip: 'บัญชี Mindverse และข้อมูลผู้ใช้ที่เกี่ยวข้อง',
    editName: 'แก้ไขชื่อ',
  ...
  members: {
    ...
    invitationSentTip: 'ส่งคําเชิญแล้ว และพวกเขาสามารถลงชื่อเข้าใช้ Mindverse เพื่อเข้าถึงข้อมูลทีมของคุณได้',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      onTrial: 'ทดลองใช้',
      exhausted: 'โควต้าหมด',
      desc: 'บริการโฮสติ้ง OpenAI ที่ให้บริการโดย Mindverse ช่วยให้คุณใช้โมเดลต่างๆ เช่น GPT-3.5 ก่อนที่โควต้าการทดลองใช้ของคุณจะหมด คุณจําเป็นต้องตั้งค่าผู้ให้บริการรุ่นอื่นๆ',
      callTimes: 'เวลาโทร',
  ...
  about: {
    ...
    nowAvailable: 'Mindverse {{version}} พร้อมใช้งานแล้ว',
    latestAvailable: 'Mindverse {{version}} เป็นเวอร์ชันล่าสุดที่มี',
  },
  appMenus: {
    overview: 'ตรวจ สอบ',
    promptEng: 'ออเคสตร้า',
