const translation = {
  ...
  externalAPIPanelDescription: 'External knowledge API is used to connect to a knowledge base outside of Mindverse and retrieve knowledge from that knowledge base.',
  ...
  intro1: 'Knowledge can be integrated into Mindverse application',
  intro2: 'as a context',
  intro3: ',',
  intro4: 'or it ',
