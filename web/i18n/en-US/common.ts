const translation = {
  ...
  account: {
    ...
    langGeniusAccount: "Swiftpage Account",
    langGeniusAccountTip: "Your Swiftpage account and related user data.",
    editName: "Edit Name",
    showAppLength: "Show {{length}} apps",
    delete: "Delete Account",
    deleteTip:
      "Deleting your account will permanently erase all your data and it cannot be recovered.",
    deleteConfirmTip:
      "To confirm, please send the following from your registered email to ",
  },
  members: {
    team: "Team",
    invite: "Add",
    ...
    invitationSentTip:
      "Invitation sent, and they can log in to Swiftpage to access your team data.",
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: "The OpenAI hosting service provided by Swiftpage allows you to use models like GPT-3.5. Before your trial quota runs out, you need to set up other model providers.",
  ...
  apiBasedExtension: {
    title:
      "API extensions provide centralized API management and simplify configuration for easy use in Swiftpage applications.",
  ...
  about: {
    ...
    nowAvailable: "Swiftpage {{version}} is now available.",
    latestAvailable: "Swiftpage {{version}} is the latest version available.",
  },
  appMenus: {
    overview: "Monitoring",
