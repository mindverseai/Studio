const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Mindverse Account',
    langGeniusAccountTip: 'Your Mindverse account and related user data.',
    editName: 'Edit Name',
  ...
  members: {
    ...
    invitationSentTip: 'Invitation sent, and they can log in to Mindverse to access your team data.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'The OpenAI hosting service provided by Mindverse allows you to use models like GPT-3.5. Before your trial quota runs out, you need to set up other model providers.',
  ...
  about: {
    ...
    nowAvailable: 'Mindverse {{version}} is now available.',
    latestAvailable: 'Mindverse {{version}} is the latest version available.',
  },
  appMenus: {
    overview: 'Monitoring',
