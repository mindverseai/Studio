const translation = {
  list: {
    title: 'Documents',
    desc: 'All files of the Knowledge are shown here, and the entire Knowledge can be linked to Mindverse citations or indexed via the Chat plugin.',
    ...
    empty: {
      ...
      sync: {
        tip: 'Mindverse will periodically download files from your Notion and complete processing.',
      },
    },
    delete: {
