const translation = {
  ...
  welcome: 'Welcome to Mindverse, please sign in to continue.',
  email: 'Email address',
  ...
  license: {
    tip: 'Before starting Mindverse Community Edition, please read',
    link: 'Open-source License',
  },
  join: 'Join ',
  joinTipStart: 'Invite you join ',
  joinTipEnd: ' team on Mindverse',
  invalid: 'The link has expired',
  explore: 'Explore Mindverse',
  ...
  resetPasswordDesc: 'Type the email you used to sign up for Mindverse and we\'ll send you a password reset email.',
  ...
  licenseExpiredTip: 'The Mindverse Enterprise license for your workspace has expired. Please contact your administrator to continue using Mindverse.',
  licenseLost: 'License Lost',
  licenseLostTip: 'Failed to connect to Mindverse license server. Please contact your administrator to continue using Mindverse.',
  licenseInactive: 'License Inactive',
  licenseInactiveTip: 'The Mindverse Enterprise license for your workspace is inactive. Please contact your administrator to continue using Mindverse.',
}
