const translation = {
  ...
  form: {
    ...
    descInfo:
      "Please write a clear textual description to outline the content of the Knowledge. This description will be used as a basis for matching when selecting from multiple Knowledge for inference.",
    descPlaceholder:
      "Describe what is in this data set. A detailed description allows AI to access the content of the data set in a timely manner. If empty, LangGenius will use the default hit strategy.",
    ...
    upgradeHighQualityTip:
      "Once upgrading to High Quality mode, reverting to Economical mode is not available",
    ...
    retrievalSetting: {
      ...
      longDescription:
        " about retrieval method, you can change this at any time in the Knowledge settings.",
    },
    ...
    indexMethodChangeToEconomyDisabledTip:
      "Not available for downgrading from HQ to ECO",
  },
};
