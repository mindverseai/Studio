const translation = {
  ...
  stepOne: {
    ...
    website: {
      ...
      firecrawlDocLink:
        "https://docs.mindverse.ai/guides/knowledge-base/sync-from-website",
  ...
  otherDataSource: {
    ...
    description:
      "Currently, Mindverse's knowledge base only has limited data sources. Contributing a data source to the Mindverse knowledge base is a fantastic way to help enhance the platform's flexibility and power for all users. Our contribution guide makes it easy to get started. Please click on the link below to learn more.",
