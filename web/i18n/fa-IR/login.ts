const translation = {
  ...
  welcome: 'به Mindverse خوش آمدید، لطفا برای ادامه وارد شوید.',
  email: 'آدرس ایمیل',
  ...
  license: {
    tip: 'قبل از شروع Mindverse Community Edition، GitHub را بخوانید',
    link: 'مجوز منبع باز',
  },
  join: 'عضویت',
  joinTipStart: 'شما را دعوت می‌کنیم به',
  joinTipEnd: 'تیم در Mindverse',
  invalid: 'لینک منقضی شده است',
  explore: 'کاوش Mindverse',
  ...
  resetPasswordDesc: 'ایمیلی را که برای ثبت نام در Mindverse استفاده کرده اید تایپ کنید و ما یک ایمیل بازنشانی رمز عبور برای شما ارسال خواهیم کرد.',
  licenseInactive: 'مجوز غیر فعال',
  licenseLost: 'مجوز گم شده است',
  licenseExpired: 'مجوز منقضی شده است',
  licenseExpiredTip: 'مجوز Mindverse Enterprise برای فضای کاری شما منقضی شده است. لطفا برای ادامه استفاده از Mindverse با سرپرست خود تماس بگیرید.',
  licenseInactiveTip: 'مجوز Mindverse Enterprise برای فضای کاری شما غیرفعال است. لطفا برای ادامه استفاده از Mindverse با سرپرست خود تماس بگیرید.',
  licenseLostTip: 'اتصال سرور مجوز Mindverse انجام نشد. لطفا برای ادامه استفاده از Mindverse با سرپرست خود تماس بگیرید.',
}
