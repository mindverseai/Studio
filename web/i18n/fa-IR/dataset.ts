const translation = {
  ...
  intro1: 'دانش می‌تواند در برنامه Mindverse ',
  ...
  externalAPIPanelDescription: 'API دانش خارجی برای اتصال به یک پایگاه دانش خارج از Mindverse و بازیابی دانش از آن پایگاه دانش استفاده می شود.',
