const translation = {
  ...
  stepOne: {
    ...
    website: {
      ...
      firecrawlDocLink: '<a href="https://docs.mindverse.ai/guides/knowledge-base/sync-from-website">https://docs.mindverse.ai/guides/knowledge-base/sync-from-website</a>',
      options: 'گزینهها',
  ...
  otherDataSource: {
    ...
    description: 'در حال حاضر، پایگاه دانش Mindverse فقط منابع داده محدودی دارد. کمک به یک منبع داده به پایگاه دانش Mindverse راهی فوق العاده برای کمک به افزایش انعطاف پذیری و قدرت پلتفرم برای همه کاربران است. راهنمای مشارکت ما شروع کار را آسان می کند. لطفا برای کسب اطلاعات بیشتر روی لینک زیر کلیک کنید.',
