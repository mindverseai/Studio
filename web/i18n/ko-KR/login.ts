const translation = {
  pageTitle: '시작하기 🎉',
  welcome: '👋 Mindverse에 오신 것을 환영합니다. 계속하려면 로그인하세요.',
  email: '이메일 주소',
  ...
  checkEmailForResetLink: '비밀번호 재설��� 링크를 확인하려면 이메일을 확인하세요. 몇 분 내에 나타나지 않으면 스팸 폴더를 확인하세요.',
  ...
  license: {
    tip: 'Mindverse Community Edition을 시작하기 전에 GitHub의',
    link: '오픈 소스 라이선스',
  },
  join: '가입하기',
  ...
  enterYourName: '사용자 이름을 입력�� 주세요',
  noLoginMethodTip: '인증 방법을 추가하려면 시스템 관리자에게 문의하십시오.',
  resetPasswordDesc: 'Mindverse에 가입할 때 사용한 이메일을 입력하면 비밀번호 재설정 이메일을 보내드립니다.',
  licenseInactiveTip: '워크스페이스의 Mindverse Enterprise 라이선스가 비활성화되었습니다. Mindverse를 계속 사용하려면 관리자에게 문의하세요.',
  licenseLost: '라이센스 분실',
  licenseLostTip: 'Mindverse 라이선스 서버에 연결할 수 없습니다. Mindverse를 계속 사용하려면 관리자에게 문의하세요.',
  licenseInactive: 'License Inactive(라이선스 비활성)',
  licenseExpired: '라이센스가 만료되었습니다.',
  licenseExpiredTip: '워크스페이스의 Mindverse Enterprise 라이선스가 만료되었습니다. Mindverse를 계속 사용하려면 관리자에게 문의하세요.',
}
