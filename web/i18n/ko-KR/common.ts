const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Mindverse 계정',
    langGeniusAccountTip: '귀하의 Mindverse 계정 및 관련 사용자 데이터.',
    editName: '이름 편집',
  ...
  members: {
    ...
    invitationSentTip: '초대가 전송되었으며, Mindverse에 로그인하여 팀 데이터에 액세스할 수 있습니다.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'Mindverse에서 제공하는 OpenAI 호스팅 서비스를 사용하면 GPT-3.5와 같은 모델을 사용할 수 있습니다. 평가판 할당량이 소진되기 전에 다른 모델 공급자를 설정해야 합니다.',
      callTimes: '호출 횟수',
  ...
  modelProvider: {
    ...
    rerankModel: {
      key: '재랭크 모델',
      tip: '재���크 모델은 사용자 쿼리와의 의미적 일치를 기반으로 후보 문서 목록을 재배열하여 의미적 순위를 향상시킵니다.',
    },
    quota: '할당량',
    searchModel: '검색 모델',
  ...
  about: {
    changeLog: '변경 로그',
    updateNow: '지금 업데이트',
    nowAvailable: 'Mindverse {{version}}을(를) 사용할 수 있습니다.',
    latestAvailable: 'Mindverse {{version}}이(가) 최신 버전입니다.',
  },
  appMenus: {
    overview: '모니터링',
    promptEng: '오케스트레이트',
