const translation = {
  ...
  license: {
    tip: '启动 Mindverse 社区版之前, 请阅读 GitHub 上的',
    link: '开源协议',
  },
  join: '加入 ',
  joinTipStart: '邀请你加入 ',
  ...
  resetPassword: '重置密码',
  resetPasswordDesc: '输入您用于注册 Mindverse 的电子邮件，我们将向您发送密码重置邮件。',
  backToLogin: '返回登录',
  ...
  licenseExpiredTip: '您工作区的 Mindverse Enterprise 许可证已过期。请联系您的管理员以继续使用 Mindverse。',
  licenseLost: '许可证丢失',
  licenseLostTip: '无法连接到 Mindverse 许可证服务器。请联系您的管理员以继续使用 Mindverse。',
  licenseInactive: '许可证未激活',
  licenseInactiveTip: '您工作区的 Mindverse Enterprise 许可证未启用。请联系您的管理员以继续使用 Mindverse。',
}
