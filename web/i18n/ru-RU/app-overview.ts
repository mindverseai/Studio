const translation = {
  ...
  apiKeyInfo: {
    ...
    tryCloud: 'Или попробуйте облачную версию Mindverse с бесплатной квотой',
  },
  overview: {
    title: 'Обзор',
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip: 'Помогает посетителям понять, какие данные собирает приложение, см. <privacyPolicyLink>Политику конфиденциальности</privacyPolicyLink> Mindverse.',
      ...
      embedded: {
        ...
        chromePlugin: 'Установите расширение Mindverse Chatbot для Chrome',
        copied: 'Скопировано',
        copy: 'Копировать',
      },
      qrcode: {
