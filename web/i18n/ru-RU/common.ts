const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Учетная запись Mindverse',
    langGeniusAccountTip: 'Ваша учетная запись Mindverse и связанные с ней пользовательские данные.',
  ...
  members: {
    ...
    invitationSentTip: 'Приглашение отправлено, и они могут войти в Mindverse, чтобы получить доступ к данным вашей команды.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'Хостинговая служба OpenAI, предоставляемая Mindverse, позволяет вам использовать такие модели, как GPT-3.5. Прежде чем ваша пробная квота будет исчерпана, вам необходимо настроить других поставщиков моделей.',
  ...
  apiBasedExtension: {
    title: 'API-расширения обеспечивают централизованное управление API, упрощая настройку для удобного использования в приложениях Mindverse.',
  ...
  about: {
    ...
    nowAvailable: 'Mindverse {{version}} теперь доступен.',
    latestAvailable: 'Mindverse {{version}} - последняя доступная версия.',
  },
  appMenus: {
    overview: 'Мониторинг',
