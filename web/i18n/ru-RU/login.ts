const translation = {
  ...
  welcome: 'Добро пожаловать в Mindverse, пожалуйста, войдите, чтобы продолжить.',
  ...
  license: {
    tip: 'Перед запуском Mindverse Community Edition ознакомьтесь с лицензией GitHub',
    link: 'Лицензия с открытым исходным кодом',
  },
  join: 'Присоединиться',
  joinTipStart: 'Приглашаем вас присоединиться к',
  joinTipEnd: 'команде на Mindverse',
  invalid: 'Ссылка истекла',
  explore: 'Изучить Mindverse',
  ...
  resetPasswordDesc: 'Введите адрес электронной почты, который вы использовали для регистрации в Mindverse, и мы отправим вам электронное письмо для сброса пароля.',
  or: 'ИЛИ',
  licenseInactive: 'Лицензия неактивна',
  licenseLostTip: 'Не удалось подключить сервер лицензий Mindverse. Обратитесь к своему администратору, чтобы продолжить использование Mindverse.',
  licenseExpired: 'Срок действия лицензии истек',
  licenseLost: 'Утеряна лицензия',
  licenseInactiveTip: 'Лицензия Mindverse Enterprise для рабочего пространства неактивна. Обратитесь к своему администратору, чтобы продолжить использование Mindverse.',
  licenseExpiredTip: 'Срок действия лицензии Mindverse Enterprise для рабочего пространства истек. Обратитесь к своему администратору, чтобы продолжить использование Mindverse.',
}
