const translation = {
  ...
  intro1: 'Базу знаний можно интегрировать в приложение Mindverse ',
  ...
  externalAPIPanelDescription: 'Внешний API базы знаний используется для подключения к базе знаний за пределами Mindverse и извлечения знаний из этой базы знаний.',
  chunkingMode: {
    general: 'Общее',
