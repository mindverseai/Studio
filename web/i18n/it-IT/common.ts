const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Account Mindverse',
  ...
  members: {
    ...
    invitationSentTip:
      'Invito inviato, e possono accedere a Mindverse per accedere ai dati del tuo team.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'Il servizio di hosting OpenAI fornito da Mindverse ti consente di utilizzare modelli come GPT-3.5. Prima che la tua quota di prova sia esaurita, devi configurare altri fornitori di modelli.',
  ...
  about: {
    ...
    nowAvailable: 'Mindverse {{version}} è ora disponibile.',
    latestAvailable: 'Mindverse {{version}} è l\'ultima versione disponibile.',
  },
  appMenus: {
