const translation = {
  ...
  welcome: 'Benvenuto su Mindverse, per favore accedi per continuare.',
  ...
  license: {
    tip: 'Prima di avviare Mindverse Community Edition, leggi su GitHub',
    link: 'Licenza open-source',
  },
  join: 'Unisciti',
  joinTipStart: 'Invitato a unirti al',
  joinTipEnd: 'team su Mindverse',
  invalid: 'Il link è scaduto',
  explore: 'Esplora Mindverse',
  ...
  resetPasswordDesc: 'Digita l\'e-mail che hai utilizzato per registrarti su Mindverse e ti invieremo un\'e-mail per reimpostare la password.',
  ...
  licenseLostTip: 'Impossibile connettersi al server licenze Mindverse. Contatta il tuo amministratore per continuare a utilizzare Mindverse.',
  licenseExpired: 'Licenza scaduta',
  licenseLost: 'Licenza persa',
  licenseExpiredTip: 'La licenza Mindverse Enterprise per la tua area di lavoro è scaduta. Contatta il tuo amministratore per continuare a utilizzare Mindverse.',
  licenseInactiveTip: 'La licenza Mindverse Enterprise per la tua area di lavoro è inattiva. Contatta il tuo amministratore per continuare a utilizzare Mindverse.',
