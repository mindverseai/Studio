        ...
        <div className="bg-white ">
            ...
            <div className="mb-5">
              ...
              <div className="mt-1">
                <input
                  ...
                  className={
                    "appearance-none block w-full rounded-lg pl-[14px] px-3 py-2 border border-gray-200 hover:border-gray-300 hover:shadow-sm focus:outline-none focus:ring-primary-500 focus:border-primary-500 placeholder:text-gray-400 caret-primary-600 sm:text-sm"
                  }
                />
                {errors.email && (
          ...
          <div className="block w-full mt-2 text-xs text-gray-600">
            ...
            <Link
              ...
              href={"https://mindverse.studio/license"}
            >
