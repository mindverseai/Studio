    ...
    return isFocus ? (
      <div>
        ...
        >
          {tempSuggestedQuestions.map((question, index) => (
            <div
              key={index}
              className="group relative rounded-lg border border-gray-200 flex items-center pl-2.5 hover:border-gray-300 hover:bg-white"
            >
      ...
      <div className="mt-1.5 flex flex-wrap">
        {notEmptyQuestions.map((question, index) => (
          <div
            key={index}
            className="mt-1 mr-1 max-w-full truncate last:mr-0 shrink-0 leading-8 items-center px-2.5 rounded-lg border border-gray-200 shadow-xs bg-white text-[13px] font-normal text-gray-900 cursor-pointer"
            title={question}
          >
            {question}
          </div>
