    ...
    >
      <PortalToFollowElemTrigger onClick={() => !nodesReadOnly && setOpen((v) => !v)}>
        <TipPopup title={t("workflow.changeHistory.title")}>
          ...
          >
            <RiHistoryLine
              className={`w-4 h-4 hover:bg-black/5 hover:text-gray-700 ${
        ...
        <div className="flex flex-col ml-2 min-w-[240px] max-w-[360px] bg-white border-[0.5px] border-gray-200 shadow-xl rounded-xl overflow-y-auto">
          ...
          {!!calculateChangeList.statesCount && (
            <>
              ...
              >
                <div>
                  <div className={cn("flex items-center text-[13px] font-medium leading-[18px]")}>
          ...
          <div className="px-3 w-[240px] py-2 text-xs text-gray-500">
            <div className="flex items-center mb-1 h-[22px] font-medium uppercase">
