...
const Chatbot = () => {
  ...
  const mindverseIcon = <LogoHeader />;
  ...
  useEffect(() => {
    ...
    if (site) {
      ...
      else document.title = `${site.title} - Powered by Mindverse`;
    }
  ...
  return (
    <div>
      <Header
        isMobile={isMobile}
        title={site?.title || ""}
        customerIcon={isDify() ? mindverseIcon : ""}
      ...
      <div className="flex bg-white overflow-hidden">
        <div
          className={cn(
            "h-[100vh] grow flex flex-col overflow-y-auto",
        ...
        >
          {showConfigPanelBeforeChat &&
            ...
            !appPrevChatList.length && (
              <div
                className={cn(
                  "flex w-full items-center justify-center h-full tablet:px-4",
                  isMobile && "px-4"
                )}
              >
                <ConfigPanel />
              ...
              {!isMobile && (
                <div className="absolute top-2.5 right-3 z-20">
                  <Tooltip popupContent={t("share.chat.resetChat")}>
                    <div
                      className="p-1.5 bg-white border-[0.5px] border-gray-100 rounded-lg shadow-md cursor-pointer"
