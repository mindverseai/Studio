                ...
                <Menu.Item>
                  {({ active }) => (
                    <div className="p-1" onClick={() => handleLogout()}>
                      <div
                        className={classNames(
                          "flex items-center justify-between h-9 px-3 rounded-lg cursor-pointer group hover:bg-state-base-hover",
                          active && "bg-state-base-hover"
                        )}
                      >
                        ...
                        <LogOut01 className="hidden w-4 h-4 text-text-tertiary group-hover:flex" />
                      </div>
                    </div>
                  )}
                </Menu.Item>
